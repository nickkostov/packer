...
$JavaMsi = "https://aka.ms/download-jdk/microsoft-jdk-17.0.12-windows-x64.msi"
$file = "JDK-17.msi"

Invoke-WebRequest -Uri $JavaMsi -OutFile $file

msiexec /i $file ADDLOCAL=FeatureMain,FeatureEnvironment,FeatureJarFileRunWith,FeatureJavaHome INSTALLDIR="c:\Program Files\Microsoft\" /quiet
